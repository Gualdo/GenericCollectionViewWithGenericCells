...
final class Navigator {
    ...
    func show(segue: Segue, sender: UIViewController) {
        ...
        case .home(let source):
            let homeViewController = GenericCollectionViewController(source: source, title: "Menu")
        ...
        case .games(let source):
            let vc = GenericCollectionViewController(source: source, title: "Games", sectionHeaderViews: sectionViewsArray != nil ? viewsForGameSection : nil)
            show(target: vc, sender: sender)
        case .movies(let source):
            let vc = GenericCollectionViewController(source: source, title: "Movies", sectionHeaderViews: sectionViewsArray != nil ? viewsForMoviesSection : nil)
            show(target: vc, sender: sender)
        case .gamesAndMovies(let source):
            let vc = GenericCollectionViewController(source: source, title: "Movies and games", sectionHeaderViews: sectionViewsArray != nil ? viewsForMoviesAndGamesSection : nil)
            show(target: vc, sender: sender)
        case .error:
